...
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _nodeListToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }

function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function _nodeListToArray (nodeList) {
    if (nodeList instanceof NodeList) return Array.prototype.slice.call(nodeList);
}
...
var Gantt = function () {
  ...
  $.delegate = function (element, event, selector, callback) {
    element.addEventListener(event, function (e) {
      var delegatedTarget = jQuery(e.target).closest(selector);
  ...
  var Bar = /*#__PURE__*/function () {
    ...
    _createClass(Bar, [{
      ...
      key: "draw_stroke_only_bar",
      value: function draw_stroke_only_bar() {
      ...
      value: function setup_click_event() {
        ...
        $.on(this.group, this.gantt.options.popup_trigger, function (e) {
          e.stopPropagation();
          ...
          jQuery(_this2.group).addClass('active');
        });
    ...
    _createClass(Arrow, [{
      ...
      value: function calculate_path() {
        ...
        var condition = function condition() {
          return _this3.to_task.$bar.getX() < start_x + _this3.gantt.options.padding && start_x > _this3.from_task.$bar.getX() + _this3.gantt.options.padding;
        };
    ...
    _createClass(Gantt, [{
      ...
      value: function setup_options(options) {
        var default_options = {
          ...
          popup_trigger: 'click',
          language: 'tr',
          show_popup: function show_popup(task) {},
        ...
        try {
          var _loop = function _loop() {
            ...
            arrows = task.dependencies.map(function (task_id) {
              ...
              _this6.layers.arrow.appendChild(arrow.element);
      ...
      key: "show_popup",
      value: function show_popup(task) {
